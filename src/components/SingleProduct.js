...
const SingleProduct = ({cart,dispatch}) => {
  ...
  const callMe=async()=>{
    if(!isAvailable)
      await dispatch(actions.newAction(product));
            ...
            <div style={{ paddingLeft: "40px" }}>
              {isAvailable ? (
                <>
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      dispatch(actions.removeAction({...isAvailable}))
                      else
                      dispatch(actions.subAction({...isAvailable}))
                    }}
                  >
                  ...
                  <button
                    className="ui black icon button"
                    size="small"
                    onClick={() =>dispatch(actions.addAction(product))}
                  >
                ...
                <Button
                  ...
                  content="Add to Cart"
                  onClick={() => {
                    dispatch(actions.newAction(product))
                  }}
                />
              )}
